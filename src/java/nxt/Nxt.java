...
public final class Nxt {
    ...
    static {
        System.out.println("Initializing NXL Lite server version " + Nxt.VERSION);
    ...
    public static void shutdown() {
        ...
        ThreadPool.shutdown();
        Db.shutdown();
        Logger.logMessage("NXL Lite server " + VERSION + " stopped.");
        Logger.shutdown();
    }
    ...
    private static class Init {
        ...
        static {
            ...
            Logger.logMessage("NXL Lite server " + VERSION + " started successfully.");
