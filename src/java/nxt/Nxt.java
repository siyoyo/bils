...
public final class Nxt {
    ...
    static {
        System.out.println("Initializing MYS Lite server version " + Nxt.VERSION);
    ...
    public static void shutdown() {
        ...
        ThreadPool.shutdown();
        Db.shutdown();
        Logger.logMessage("MYS Lite server " + VERSION + " stopped.");
        Logger.shutdown();
    }
    ...
    private static class Init {
        ...
        static {
            ...
            Logger.logMessage("MYS Lite server " + VERSION + " started successfully.");
